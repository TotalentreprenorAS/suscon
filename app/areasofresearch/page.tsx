...
export default function AreasOfResearch() {
  return (
    <section className="container mx-auto px-4 py-20">
      <h1 className="text-4xl font-bold text-center mb-10">Areas of Research</h1>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-6xl mx-auto text-lg mb-10"> 
      {topics.map((topic, index) => (
        <ProjectCards topics={topic} key={index}
        />
      ))}
      </div>
    </section>
